...
const Profile = {
  getProfile: (id, role, callback) => {
    ...
    let SQLStudent;
    SQLStudent = "SELECT student.student_id AS TeacherID, concat(student.first_name,' ',student.last_name) ";
    SQLStudent += "as Name, student.email_address AS Emai, student.role AS Role, student.group_name AS GroupName, ";
    SQLStudent += "CONCAT(teacher.first_name, ' ', teacher.last_name) as NameTeacher FROM student JOIN group_cpe ";
    ...
    SQLAdmin += "AS Emai, role AS Role FROM admin WHERE admin_id =" + "'" + id + "'";
